...
@section('content')
    ...
    <div class="container rounded-3 shadow p-4">
        <div class="d-flex align-items-center mb-4">
            <h3 class="mb-0 text-primary-color">Chỉnh sửa thông tin giáo viên</h3>
        </div>
        <div class="card-body">
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            const initialIsActive = $('#is_active').prop('checked');
            $('#statusText').text(initialIsActive ? 'Hoạt động' : 'Ngừng hoạt động');
        });
    </script>
@endpush
