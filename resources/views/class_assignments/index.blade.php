    ...
    @section('content')
        <div class="container">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" id="year-filter-form" class="row g-3">
                        <div class="col-md-5">
                            <label for="academic_year_id" class="form-label">Năm học</label>
                            <select name="academic_year_id" id="academic_year_id" class="form-select" onchange="document.getElementById('year-filter-form').submit()">
