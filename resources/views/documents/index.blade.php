            ...
            <div class="d-flex align-items-center gap-3">
                @if(Auth::user()->isTeacher())
                    <a href="{{ route('documents.create') }}"
                       class="btn btn-primary-color text-white px-3 py-2 rounded-pill shadow-sm hover-lift">
                        Tải lên tài liệu
                    </a>
                @endif
            </div>
                    ...
                    <div class="row g-4 align-items-end">
                        ...
                        <div class="col-md-3">
                            <select name="subject_id" id="subject_id"
                                    class="form-select border-primary-subtle shadow-sm rounded-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="teacher_id" id="teacher_id"
                                    ...
                                    @foreach($teachers as $teacher)
                                        <option
                                            value="{{ $teacher->id }}" {{ request('teacher_id') == $teacher->id ? 'selected' : '' }}>
                                            {{ $teacher->full_name }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            <div class="row g-4">
                @forelse($documents as $document)
                    <div class="col-md-6 col-lg-4">
                        <div
                            class="document-card card h-100 border-0 shadow-sm rounded-4 overflow-hidden hover-lift-card">
                                ...
                                <div class="dropdown position-absolute top-0 end-0 mt-3 me-3 z-3">
                                    @if(Auth::user()->isTeacher())
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 py-2">
                                            <li>
                                                <a class="dropdown-item px-3 py-2 rounded-2"
                            ...
                            <div class="card-body d-flex flex-column p-4">
                                ...
                                <div class="teacher-info d-flex align-items-center p-3 bg-light rounded-3 mb-3">
                                    <div
                                        class="teacher-avatar bg-primary bg-opacity-10 text-primary-color rounded-circle d-flex align-items-center justify-content-center me-3"
                                ...
                                <div
                                    class="file-info d-flex align-items-center justify-content-between text-muted small mb-3 p-2 bg-primary-subtle rounded-2">
                                <span>
                                ...
                                <div class="d-flex align-items-center justify-content-end gap-2">
                                    @if(Auth::user()->isStudent())
                                        <a href="{{ route('documents.download', $document) }}"
                                           class="btn btn-outline-primary-color rounded-pill px-3 py-2 fw-semibold hover-lift">
                                            Tải xuống
                                        </a>
                                    @else
                                        <div></div>
                                    ...
                                    <a href="{{ route('documents.show', $document) }}"
                                       class="btn btn-primary-color rounded-pill px-3 py-2 fw-semibold hover-lift">
                                        Xem chi tiết
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="empty-state text-center py-5">
                            <div class="empty-illustration mb-4">
                                <div
                                    class="bg-light border rounded-circle d-inline-flex align-items-center justify-content-center shadow-sm"
                            ...
                            <div class="d-flex gap-3 justify-content-center">
                                <a href="{{ route('documents.index') }}"
                                   class="btn btn-primary-color rounded-pill px-4 hover-lift">
                                    <i class="fas fa-refresh me-2"></i>Xóa bộ lọc
                                </a>
                                @if(Auth::user()->isTeacher())
                                    <a href="{{ route('documents.create') }}"
                                       class="btn btn-outline-primary-color rounded-pill px-4 hover-lift">
